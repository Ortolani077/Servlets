                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        ...
                                                        <form class="form-material form-static-label" action="<%= request.getContextPath() %>/ServletUsuarioController" method="post" id="formUser">
                                                            ...
                                                            <button class="btn btn-success waves-effect waves-light" onclick="salvarForm();">Salvar</button>
